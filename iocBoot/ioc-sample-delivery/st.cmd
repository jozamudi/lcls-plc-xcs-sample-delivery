...
epicsEnvSet("IPADDR",           "172.21.38.25")
...
system("${ADS_IOC_TOP}/scripts/add_route.sh 172.21.38.25 ^172.*$")
...
dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:sample-delivery,PROJECT=sample-delviery.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.18.2,PLC_HOST=172.21.38.25")
